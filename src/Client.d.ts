...
declare function CreateTimer(LuaFunction: TimerCallback, Interval: number): number;
declare function CreateTimer(LuaFunction: any, Interval: number, userArgs: any[]): number;
