...
declare function mariadb_query(handleId: number, query: number, callbackFunction: Function, ...callbackArgs: any[]): void;
declare function mariadb_async_query(handleId: number, query: number, callbackFunction: Function, ...callbackArgs: any[]): void;
